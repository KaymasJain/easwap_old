...
function funcToSelect(coinId) {
    if (account) {
        if (account != web3.eth.accounts[0]) {
            ...
            var link;
            if (networkId == 3) {
                link = `<a class="etherLink" target='_blank' href='https://ropsten.etherscan.io/address/${account}'>${text}</a>`
            } else {
                link = `<a class="etherLink" target='_blank' href='https://etherscan.io/address/${account}'>${text}</a>`
            }
...
$('#showHideQty').click(function() {
    if ($('#showHideQty').text() == "SHOW QUANTITY") {
        ...
        setTimeout("$('#showHideQty').text('HOW QUANTITY')", 100);
        setTimeout("$('#showHideQty').text('OW QUANTITY')", 200);
        setTimeout("$('#showHideQty').text('W QUANTITY')", 300);
        setTimeout("$('#showHideQty').text('E QUANTITY')", 400);
        setTimeout("$('#showHideQty').text('DE QUANTITY')", 500);
        setTimeout("$('#showHideQty').text('IDE QUANTITY')", 600);
        setTimeout("$('#showHideQty').text('HIDE QUANTITY')", 700);
        ...
        $('.coinsQtyBox').slideToggle();
        setTimeout("$('#showHideQty').text('IDE QUANTITY')", 100);
        setTimeout("$('#showHideQty').text('DE QUANTITY')", 200);
        setTimeout("$('#showHideQty').text('E QUANTITY')", 300);
        setTimeout("$('#showHideQty').text('W QUANTITY')", 400);
        setTimeout("$('#showHideQty').text('OW QUANTITY')", 500);
        setTimeout("$('#showHideQty').text('HOW QUANTITY')", 600);
        setTimeout("$('#showHideQty').text('SHOW QUANTITY')", 700);
    }
})
